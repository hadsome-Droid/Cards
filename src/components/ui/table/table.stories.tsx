      ...
      <>
        ...
        <Table.Body>
          <Table.Row>
            ...
            <Table.Cell>
              <Typography.Link href={'https://react.dev/'} target={'_blank'} variant={'link1'}>
                Docs
              </Typography.Link>
            </Table.Cell>
        ...
        <Table.Body>
          {data.map(el => (
            <Table.Row key={el.id}>
              ...
              <Table.Cell>
                <Typography.Link href={el.link.path} target={'_blank'} variant={'link1'}>
                  {el.link.title}
                </Typography.Link>
              </Table.Cell>
...
export const Empty = {
  render: () => {
    ...
    return (
      <Table.Empty>
        <Typography.Body1 style={styles} variant={'body1'}>
